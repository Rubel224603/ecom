                ...
                <div class="card-body">
                    <form action="{{route('admin.coupon.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"  placeholder="add coupon code" name="coupon_code" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <lable>   <input type="radio"   value="1"  name="coupon_status" checked/> Published</lable>
                                <lable>   <input type="radio"   value="0"  name="coupon_status"/> Unpublished</lable>
                            </div>
                        </div>
