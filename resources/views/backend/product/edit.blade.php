                    ...
                    <form action="{{route('product.update',['id'=>$product->id])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select id="" name="unit_id" class="form-control">
                                    ...
                                    @foreach($units as $unit)
                                        <option value="{{$unit->id}}" @selected($unit->id == $product->brand_id)>{{$unit->name}}</option>
                                    @endforeach
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="number" class="form-control"  value="{{$product->product_price}}" placeholder="Product Price" name="product_price" />
                                    <input type="number" class="form-control"  value="{{$product->selling_price}}" placeholder="Sellig price" name="selling_price" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="number" class="form-control" value="{{$product->stock}}" placeholder="stock number" name="stock" />
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <lable>   <input type="radio"   value="1"  name="status" {{$product->status == 1 ? "checked": '' }}/> Published</lable>
                                <lable>   <input type="radio"   value="2"  name="status" {{$product->status == 2 ? "checked":''}}/> Unpublished</lable>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                ...
                                @foreach($product->otherImage as $otherImage)
                                    <img src="{{asset($otherImage->other_image)}}" alt="" height="100"/>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <textarea id="" class="form-control" placeholder="sort description" name="short_description" >{{$product->short_description}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label" for="basic-default-message">Long Description</label>
                            <div class="col-sm-10">
                                <textarea id="summernote" class="form-control" placeholder="long description" name="long_description" >{{$product->long_description}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="" class="col-sm-2 col-form-label">Meta Title</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="{{$product->meta_title}}" placeholder="meta title" name="meta_title">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="" class="col-sm-2 col-form-label">Meta Description</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control p-5" value="{{$product->meta_description}}"  placeholder="meta description" name="meta_description">
                            </div>
                        </div>
