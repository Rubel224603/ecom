                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="p-3">You Need to Login to Checkout .If you are not register  then, please Register first</h3>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6 ">
                            ...
                            <div class="card p-5">
                                ...
                                <form class="singin-form" action="{{route('checkout.customer-login')}}" method="POST">
                                    @csrf
